...
const HELP_MESSAGE = 'Do you have any other question?';
...
const handlers = {
    ...
    'CustomerProfitCount': function () {
        ...
        var viewURL = '/15a0001c-7db4-4cb3-aae5-8ddec0347984/data';
    ...
    'RegionWiseReport': function () {
        ...
        var viewURL = '/1a6a4a39-9ee7-4b8e-83fa-13c997c1c417/data?vf_Region=' + requestData[0].region;
    ...
    'SegmentSubcategoryReport': function () {
        ...
        // console.log(requestData);
        var viewURL = '/72e2e578-dd38-48d7-bb85-40d6737662a7/data?vf_Segment=' + requestData[0].segment + '&vf_Sub-Category=' + requestData[0].subcategory;
        console.log(viewURL);
    ...
    //let msg = "I don't understand that. Please say a valid command";
...
function login() {
    ...
    var options = { 
        ...
        body: '<tsRequest><credentials name="renewables.da@gmail.com" password="ge@12345" ><site contentUrl="renewables" /></credentials></tsRequest>'
    };
